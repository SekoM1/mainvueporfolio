  ...
  <div id="about" class="about" style="padding-top:30px;">
    <div class="container aos-init aos-animate" data-aos="fade-up">
      ...
      <div class="row" style="margin-bottom: 175px;">
        <div class="col-lg-4">
          <img src="../assets/nm-min.jpg" class="img-fluid" alt="">
        </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="fa fa-phone"></i> <strong>Phone:</strong> +27 827 026 971 </li>
                <li><i class="fa fa-building"></i> <strong>City:</strong> Cape Town, SA</li>
                <li><i class="fa fa-birthday-cake"></i> <strong>Birthday:</strong> 24 Dec 1997</li>
              </ul>
            </div>
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="fa fa-envelope"></i><strong> Email:</strong>
                  <span id="email">seko.n.mpofu@gmail.com</span>
                </li>
                <li><i class="fa fa-code"></i> <strong>Freelance:</strong> Available</li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  mounted(){
    fetch('https://sekos-api-project.herokuapp.com/testimonials')
    .then(res => res.json())
    .then(data => {
      console.log(data)
